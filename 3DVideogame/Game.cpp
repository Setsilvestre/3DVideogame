...
void Game::drawGame() {
	...
	for (int i = 0; i < myGeometry.returnPrimitives(); i++){
		glm::mat4 modelMatrix;
		modelMatrix = glm::translate(modelMatrix,myGeometry.returnTranslate(i));
		modelMatrix = glm::rotate(modelMatrix, myGeometry.returnAngle(i), myGeometry.returnRotate(i));
		modelMatrix = glm::scale(modelMatrix, myGeometry.returnScale(i));
